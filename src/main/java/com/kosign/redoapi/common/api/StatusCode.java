package com.kosign.redoapi.common.api;

public enum StatusCode {

    SUCCESS(200, "Success"),
    USER_NOT_FOUND(453, "User is not found"),
    USER_DISABLED(453, "This user is disabled"),
    ...
    NEW_PASSWORD_MUST_BE_ENCRYPTED(400, "New password must be encrypted!"),
    PASSWORD_DOES_NOT_MATCH(400, "Password does not match"),
    PASSWORD_MUST_BE_DIFFERENT_CURRENT_PASSWORD(400, "Password must be different current password!"),
    ...
    PAYMENT_TERM_REQUIRED(400, "Payment term must be not blank"),
    DUE_DATE_REQUIRED(400, "DueDateTime must be not blank"),

    AMOUNT_GREATER_THAN_ZERO(400, "Amount must be greater than zero"),

    //403 Forbidden
    FORBIDDEN(403, "You are not authorized to perform this action"),

    VIRTUAL_ACCOUNT_NOT_FOUND(404, "Virtual account not found"),
    VIRTUAL_ACCOUNT_QR_COLLECTION_NOT_FOUND(404, "Virtual account qr collection not found"),
    ...
    PARENT_ACCOUNT_USD_NOT_FOUND(404, "Parent account USD not found"),
    PARENT_ACCOUNT_KHR_NOT_FOUND(404, "Parent account KHR not found"),
    ...
    PAYER_CANNOT_UPDATE(400, "Payer cannot be update"),
    ...
    URL_NO_SUCH_HOST_IS_KNOWN(404, "Url no such host is known" ),
    ...
    PAYER_ACCOUNT_QR_EXIST(400, "This payer already has a QR Collection" ),
